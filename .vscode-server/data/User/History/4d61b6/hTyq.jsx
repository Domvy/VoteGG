...
import useSocket from "../../useSocket.js"; // 커스텀 훅 가져오기
import { getVoteCount, increaseVoteCount } from "../../../votecount.js"; // voteCount.js에서 가져오기
import "./TestChat.css";
import VoteModal from "../../Modals/VoteModal/VoteModal.jsx"; // 모달 컴포넌트
import EmojiButton from "../Buttons/EmojiButton/EmojiButton.js";
import MatterCanvas from "./MatterCanvas.jsx"; // MatterCanvas 컴포넌트 추가
