...
import { triggerResetTimer, registerHandleTurnChangeFunc } from '../../../stores/setTimerState';
...
class OpenviduFinal extends Component {
    ...
    componentDidMount() {
        ...
        // handleTurnChange 함수를 레지스트리에 등록
        registerHandleTurnChangeFunc(this.handleTurnChange.bind(this));
    }
