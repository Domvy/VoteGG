...
const RoomList = () => {
  ...
  // 그룹 선택 핸들러
  const handleJoinRoom = (roomNumber, group) => {
    navigate(`/room/${roomNumber}?group=${group}`);
  };
            ...
            <div className="room-details">
              ...
              <div className="room-buttons">
                ...
                <button
                  ...
                  onClick={() => handleJoinRoom(room.roomNumber, 'A')}
                >
                  그룹 A로 토론하기
                </button>
                <button
                  className="room-discuss-button"
                  onClick={() => handleJoinRoom(room.roomNumber, 'B')}
                >
                  그룹 B로 토론하기
                </button>
                <button
