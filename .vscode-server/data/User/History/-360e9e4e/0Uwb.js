...
const { router: inviteRouter, inviteSocketHandler } = require('./routes/invite');
...
const chatNamespace = io.of('/chat'); // 채팅 네임스페이스
const inviteNamespace = io.of('/invite'); // 초대 네임스페이스
// 소켓 핸들러 추가
chatSocketHandler(chatNamespace);
inviteSocketHandler(inviteNamespace);
///////////////////////////
